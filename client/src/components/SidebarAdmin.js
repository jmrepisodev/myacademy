    ...
    return (
      <nav className="bg-dark text-white vh-100 p-3">
        ...
        <ul className="nav nav-pills flex-column mb-auto fs-5">
          ...
          <li>
            <Link className="nav-link text-white" to="/admin/estadisticas">
             Estadísticas
            </Link>
          </li>
          <li>
            <Link className="nav-link text-white" to="/admin/cursos">
              Cursos
            </Link>
          </li>
          <li>
            <Link className="nav-link text-white" to="/admin/temas">
              Temas
            </Link>
          </li>
          <li>
          ...
          <li>
            <Link className="nav-link text-white" to="/admin/preguntas">
              Preguntas
            </Link>
          </li>
          <li>
            <Link className="nav-link text-white" to="/admin/videoclases">
              Videoclases
            </Link>
          </li>
        </ul>
